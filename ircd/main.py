...
def main():
    ...
    ap.add_argument('--no-link',action='store_const',const=True,default=False,dest='no_link',help='use linkserv')
    # parse args
    args = ap.parse_args()
    # check for SIGHUP
    ...
    serv = server.Server((args.host,args.port),do_log=log,poni=poni,ipv6=args.ipv6,configs=cfgs)
    # make adminserv
